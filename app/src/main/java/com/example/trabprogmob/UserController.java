...
public class UserController {
    ...
    // Novo método com suporte para imagem de perfil
    public void register(String userId, String email, String password, String imageUrl, OnCompleteListener<Void> callback) {
